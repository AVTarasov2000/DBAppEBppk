        ...
        <div class="container">
            <div class="row">
                ...
                <form action="${updateUrl}" method="post" class="form-inline">
                    ...
                    <input type="text" name="author" id="newCompany" class="form-group mb-2 form-control" height="30px">
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="${updateUrl}" method="post" class="form-inline">
                        <input type="hidden" name="login" value="${login}">
                        <input type="hidden" name="password" value="${password}">
                        <input type="hidden" name="prewName" value="${company}">
                ...
                <td>
                    ...
                    <form action="${updateUrl}" method="post" class="form-inline">
                        <input type="hidden" name="login" value="${login}">
                        <input type="hidden" name="password" value="${password}">
                        <input type="hidden" name="author" value="${company}">
